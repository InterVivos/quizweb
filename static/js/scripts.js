...
(function($) {
    ...
    $("#signUpForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            ...
            sformError();
            ssubmitMSG(false, "Asegúrese de llenar todos los campos!");
        } else {
    ...
    function ssubmitForm() {
        ...
        $.ajax({
            type: "POST",
            url: "register",
            data: "email=" + email + "&username=" + name + "&password1=" + password1 + "&password2=" + password2 + "&csrfmiddlewaretoken=" + $('input[name=csrfmiddlewaretoken').val(), 
    ...
    function sformSuccess() {
        $("#signUpForm")[0].reset();
        ssubmitMSG(true, "Cuenta creada exitósamente!");
    ...
    function lsubmitForm() {
        ...
        $.ajax({
            ...
            data: "username=" + email + "&password=" + password + "&csrfmiddlewaretoken=" + $('input[name=csrfmiddlewaretoken').val(),
            success:function(text){
                //alert('Successfull');
                if (text == "success") {
                    //lformSuccess();
